...
|---------------|-------------|-----------|------------|-------------|-----------|-------------|---------------|------------|
| lightgbm      |       3.392 |     3.474 |      3.565 |       5.338 |    0.8992 | 15.25%      |         8.218 | 181.7s     |
| random_forest |       2.611 |     3.509 |      3.596 |       5.377 |    0.8977 | 15.33%      |         8.252 | 228.2s     |
| ridge         |       3.894 |     3.828 |      3.951 |       5.774 |    0.882  | 18.98%      |         8.596 | 9.2s       |
| baseline      |      12.03  |    11.904 |     12.137 |      17.485 |   -0.0817 | 65.08%      |        28.559 | 0.1s       |

Rows are ordered by validation MAE, which is the metric selection used. **lightgbm** was chosen (run `b3ecd58c`).
...
- Runner-up **random_forest** trails by 0.035 min val MAE while taking +46.6s longer to fit.

## Reproducing the selected run

```bash
python -m src.models.reproduce_run --run-id b3ecd58ca26d4e828193c1e5985e9bfa
```
