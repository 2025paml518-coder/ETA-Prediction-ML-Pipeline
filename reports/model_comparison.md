...
|---------------|-------------|-----------|------------|-------------|-----------|-------------|---------------|------------|
| lightgbm      |       3.392 |     3.474 |      3.565 |       5.338 |    0.8992 | 15.25%      |         8.218 | 126.9s     |
| random_forest |       2.611 |     3.509 |      3.596 |       5.377 |    0.8977 | 15.33%      |         8.252 | 241.2s     |
| ridge         |       3.894 |     3.828 |      3.951 |       5.774 |    0.882  | 18.98%      |         8.596 | 15.4s      |
| baseline      |      12.03  |    11.904 |     12.137 |      17.485 |   -0.0817 | 65.08%      |        28.559 | 0.1s       |

Rows are ordered by validation MAE, which is the metric selection used. **lightgbm** was chosen (run `e61403e2`).
...
- Runner-up **random_forest** trails by 0.035 min val MAE while taking +114.3s longer to fit.

## Reproducing the selected run

```bash
python -m src.models.reproduce_run --run-id e61403e2a2bb46e48e2249dc4891f38e
```
