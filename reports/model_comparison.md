...
|---------------|-------------|-----------|------------|-------------|-----------|-------------|---------------|------------|
| lightgbm      |       3.408 |     3.445 |      3.54  |       5.336 |    0.8993 | 14.82%      |         8.16  | 94.9s      |
| random_forest |       2.602 |     3.492 |      3.575 |       5.394 |    0.8971 | 14.96%      |         8.263 | 192.5s     |
| ridge         |       3.669 |     3.644 |      3.746 |       5.796 |    0.8812 | 15.73%      |         8.449 | 11.2s      |
| baseline      |      12.03  |    11.904 |     12.137 |      17.485 |   -0.0817 | 65.08%      |        28.559 | 0.1s       |

Rows are ordered by validation MAE, which is the metric selection used. **lightgbm** was chosen (run `8cbc0d47`).
...
- Runner-up **random_forest** trails by 0.048 min val MAE while taking +97.7s longer to fit.
